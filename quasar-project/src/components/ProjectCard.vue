<template>
  <div>
    ...
    >
      <div class="p-2">
        <h2 class="text-base mb-2" align="center">
        ...
        <q-card-section>
          <div class="q-pa-md">
            ...
            >
              <template v-slot:top>
                <q-btn
                  v-if="this.inputsReadonly == true"
                  @click="switchState()"
                  icon="edit"
                />

                <q-btn
                  v-if="this.inputsReadonly == false"
                  @click="cancelUpdateTable()"
                  icon="close"
                />
                <q-btn
                  v-if="this.inputsReadonly == false"
                ...
                <q-btn
                  v-if="
                    this.inputsReadonly == false && this.selected.length > 0
                  "
              ...
              <template v-slot:body="props">
                <q-tr :props="props">
                  ...
                  <q-td key="Task Name" :props="props">
                    {{ props.row.Task_name }}
                    <q-popup-edit
                      :disable="inputsReadonly"
                      v-model="props.row.Task_name"
                      buttons
                      v-slot="scope"
                    >
                      <q-input
                  ...
                  <q-td key="Exp Start Date" :props="props">
                    ...
                    <q-popup-edit
                      :disable="inputsReadonly"
                      v-model="props.row.Expect_Start_Date"
                      buttons
                      v-slot="scope"
                    >
                      <q-input
              ...
              <template v-slot:bottom>
                ...
                <q-td>
                  <q-btn
                    flat
                    rounded
                    @click="addingRow ? confirmAddRow() : addRow()"
                    :icon="addingRow ? 'check' : 'add'"
                    :label="addingRow ? 'Confirm' : 'Add Row'"
                  />
                </q-td>
